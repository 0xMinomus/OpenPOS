...
export function buildDB(): SandboxDB {
  ...
  // Hanya 2 akun, tanpa passcode — ganti akun 1 klik, tanpa PIN.
  const users: User[] = [
    ...
    { id: 'u2', email: '', name: 'Kasir Preview', role: 'cashier', active: true, store_id: 's1', store_name: 'Toko Preview', has_passcode: false, created_at: ago(40), online: true, last_seen_at: new Date().toISOString() },
  ]
  ...
  const trx: Trx[] = [
    T(30, 'Kasir Preview', [{ ...rice, qty: 1 }, { ...oil, qty: 1 }], 0, 'QRIS', isoAnchor(14, 5)),
    T(29, 'Kasir Preview', [{ ...coffee, qty: 2 }, { ...water, qty: 2 }], 0, 'Cash', isoAnchor(13, 20)),
    T(28, 'Kasir Preview', [{ ...noodle, qty: 3 }], 0, 'E-Wallet', isoAnchor(11, 42)),
    T(27, 'Kasir Preview', [{ ...rice, qty: 2 }], 5000, 'Cash', isoAnchor(9, 15), 'completed', 'Bu Ratna'),
    T(26, 'Kasir Preview', [{ ...soap, qty: 2 }], 0, 'Bank Transfer', isoAnchor(8, 5)),
    T(25, 'Kasir Preview', [{ ...oil, qty: 1 }, { ...sugar, qty: 1 }], 0, 'E-Wallet', isoAnchor(16, 20, -1)),
    T(24, 'Kasir Preview', [{ ...tea, qty: 6 }], 2000, 'Cash', isoAnchor(12, 10, -1)),
    T(23, 'Kasir Preview', [{ ...noodle, qty: 10 }], 2000, 'Card', isoAnchor(13, 2, -2)),
    T(22, 'Kasir Preview', [{ ...rice, qty: 1 }], 0, 'Bank Transfer', isoAnchor(10, 55, -2), 'refunded'),
    T(21, 'Kasir Preview', [{ ...oil, qty: 3 }], 0, 'QRIS', isoAnchor(15, 44, -4)),
    T(20, 'Kasir Preview', [{ ...water, qty: 8 }], 0, 'Cash', isoAnchor(11, 5, -4)),
    T(19, 'Kasir Preview', [{ ...noodle, qty: 4 }], 0, 'Cash', isoAnchor(12, 30, -5)),
    T(18, 'Kasir Preview', [{ ...rice, qty: 1 }, { ...noodle, qty: 2 }], 0, 'Card', isoAnchor(17, 12, -6)),
    T(17, 'Kasir Preview', [{ ...coffee, qty: 4 }], 3000, 'QRIS', isoAnchor(10, 40, -7)),
    T(16, 'Kasir Preview', [{ ...sugar, qty: 3 }], 0, 'E-Wallet', isoAnchor(15, 25, -8)),
    T(15, 'Kasir Preview', [{ ...oil, qty: 2 }, { ...rice, qty: 1 }], 0, 'Bank Transfer', isoAnchor(9, 50, -9)),
    T(14, 'Kasir Preview', [{ ...noodle, qty: 8 }], 1000, 'Cash', isoAnchor(14, 15, -11)),
    T(13, 'Kasir Preview', [{ ...soap, qty: 5 }], 0, 'Card', isoAnchor(11, 30, -13)),
    T(12, 'Kasir Preview', [{ ...water, qty: 10 }, { ...tea, qty: 4 }], 0, 'QRIS', isoAnchor(16, 5, -15)),
    T(11, 'Kasir Preview', [{ ...rice, qty: 3 }], 10000, 'Cash', isoAnchor(10, 20, -17), 'completed', 'Pak Harto'),
    T(10, 'Kasir Preview', [{ ...coffee, qty: 6 }], 0, 'E-Wallet', isoAnchor(13, 45, -20)),
    T(9, 'Kasir Preview', [{ ...noodle, qty: 12 }], 0, 'Bank Transfer', isoAnchor(9, 10, -22)),
    T(8, 'Kasir Preview', [{ ...oil, qty: 2 }], 0, 'Cash', isoAnchor(15, 0, -24)),
    T(7, 'Kasir Preview', [{ ...rice, qty: 2 }, { ...sugar, qty: 2 }], 5000, 'Card', isoAnchor(11, 55, -26)),
    T(6, 'Kasir Preview', [{ ...soap, qty: 4 }, { ...water, qty: 6 }], 0, 'QRIS', isoAnchor(14, 35, -28)),
    T(5, 'Kasir Preview', [{ ...tea, qty: 12 }], 0, 'Cash', isoAnchor(10, 5, -29)),
  ]
  const movements: Movement[] = [
    ...
    { id: 'm2', product_id: 'p1', product_name: 'Beras Premium 5kg', type: 'sale', qty: -1, reason: 'Penjualan #TRX-00030', actor: 'Kasir Preview', created_at: isoAnchor(14, 5) },
    ...
    { id: 'm5', product_id: 'p7', product_name: 'Mie Instan Goreng', type: 'sale', qty: -3, reason: 'Penjualan #TRX-00028', actor: 'Kasir Preview', created_at: isoAnchor(11, 42) },
    { id: 'm6', product_id: 'p9', product_name: 'Telur Ayam 1kg', type: 'adjust', qty: -2, reason: 'Rusak/expired', actor: 'Kasir Preview', created_at: isoAnchor(16, 15, -8) },
  ...
  const notifs: Notification[] = [
    ...
    { id: 4, title: 'Transaksi Baru', message: 'Kasir Preview menyelesaikan #TRX-00030.', type: 'transaction_created', category: 'transaksi', actor_name: 'Kasir Preview', read: false, created_at: isoAnchor(14, 5), reference_type: 'transaction', reference_id: 30 },
    { id: 5, title: 'Transaksi Baru', message: 'Kasir Preview menyelesaikan #TRX-00029.', type: 'transaction_created', category: 'transaksi', actor_name: 'Kasir Preview', read: true, created_at: isoAnchor(13, 20), reference_type: 'transaction', reference_id: 29 },
    { id: 6, title: 'Transaksi Baru', message: 'Kasir Preview menyelesaikan #TRX-00026.', type: 'transaction_created', category: 'transaksi', actor_name: 'Kasir Preview', read: true, created_at: isoAnchor(8, 5), reference_type: 'transaction', reference_id: 26 },
